...
public class MineSweeper extends JPanel implements AWTEventListener, ActionListener {
  ...
  private void showAbout() {
    JOptionPane.showMessageDialog(this, "<html>Author :Schumaker Team <br>Version : 1.0</html>", "About", JOptionPane.INFORMATION_MESSAGE);
  }
  ...
  public static void main(String args[]) {
    JFrame fr = new JFrame("Schumaker Team - MineSweeper");
